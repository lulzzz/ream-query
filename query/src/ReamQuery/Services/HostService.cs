namespace ReamQuery.Services
{
    ...
    public class HostService 
    {
        ...
        public async Task<CompileResult> StartGenerated(Guid id, int dumpCount, string source, string assmName, MetadataReference context = null) 
        {
            ...
            if (compileResult.Code == Api.StatusCode.Ok)
            {
                ...
                var emitter = new Emitter(id, dumpCount);
